...
<html>
    ...
    public static function buildOrderCancellationBodyFax($order) {
    $platform_settings = \Drupal\food\Core\PlatformController::getPlatformSettings();
    $order_number_prefix = PhpHelper::getNestedValue($platform_settings,
      ['order_settings', 'order_number_prefix']);
...
<p class="MsoNormal" style="margin:0cm 0cm 0.0001pt;line-height:normal;font-size:11pt;font-family:Calibri,sans-serif"><span style="font-size: 11.5pt;font-family:Arial,sans-serif;color:rgb(34,34,34);background:white;">Hello, <strong>' . $restaurant->name . '</strong>,</span>
</p>
<p>
<span style="font-size: 10.5pt;font-family:Arial,sans-serif;color:rgb(34,34,34);">Foodondeal</span><span style="font-size: 10.5pt;font-family:Arial,sans-serif;color:rgb(34,34,34);background:white;">&nbsp;' . $order_number_prefix . '# ' . $order->order_id . ' for ' .$order->user_name. ' has been canceled. DO NOT prepare this order. If applicable, your ad fee will be reimbursed.&nbsp;</span>

</p>
<p>
<span style="background:white">Sign in to&nbsp;</span> 
<span style="font-size: 12pt;font-family:&quot;Times New Roman&quot;,serif;"><a href="' . $siteUrl . '" target="_blank" ><span style="font-size:10.5pt;font-family:Arial,sans-serif;color:rgb(17,85,204)">Foodondeal&nbsp;for Restaurants</span></a></span><span style="font-size: 10.5pt;font-family:Arial,sans-serif;color:rgb(34,34,34);background:white;">&nbsp;to get the full details. If you don&rsquo;t have a&nbsp;</span><span style="font-size: 10.5pt;font-family:Arial,sans-serif;color:rgb(34,34,34);">Foodondeal</span><span style="font-size: 10.5pt;font-family:Arial,sans-serif;color:rgb(34,34,34);background:white;">&nbsp;for Restaurants account, call Restaurant Care at </span><u><span style="font-size: 10.5pt;font-family:Arial,sans-serif;color:rgb(17,85,204);">8885181475</span></u><span style="font-size: 10.5pt;font-family:Arial,sans-serif;color:rgb(34,34,34);"><br>
<br>
